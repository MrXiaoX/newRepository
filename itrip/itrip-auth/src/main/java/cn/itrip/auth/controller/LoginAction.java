...
public class LoginAction {
	...
	public void login(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
		...
		// http://dd181d8a.ngrok.io
		String url = "https://open.weixin.qq.com/connect/qrconnect?";
		url += "appid=wx71533d4789fa5e07";
		url += "&redirect_uri=" + URLEncoder.encode("http://06256dbd.ngrok.io/itrip-auth/WeCat/callBackLogin", "GBK");
	...
	public String callBackLogin(HttpServletRequest request, HttpServletResponse response) {
		...
		url += "appid=wx71533d4789fa5e07";
		url += "&secret=b689b3fa32f200fa0fcf10842f890bb4";
