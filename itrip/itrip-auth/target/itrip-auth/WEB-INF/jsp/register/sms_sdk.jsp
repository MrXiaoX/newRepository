...
<script type="text/javascript">
    $(function () {
        $("#div_register input[name='userCode']").blur(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/api/checkUserPhone",
                "type": "GET",
                "data": {"name": userCode},
                "dataType": "json",
        ...
        $("#tijiao").click(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/api/doRegisterPhone",
                "type": "POST",
                "data": arrs,
        ...
        $("#activateTijiao").click(function () {
            ...
            alert(code);
            $.ajax({
                "url": "${pageContext.request.contextPath}/api/activatePhone",
                "type": "POST",
    ...
    <form>
        <table align="center">
            ...
            <tr>
                ...
                <td><input type="button" id="verificatioCode" value="点击生产验证码"></td>
            </tr>
        </table>
    </form>
</div>
